export const RESOURCE_ECOSYSTEM_OVERVIEW = {
    ...
    description:
        `Together with partner offerings, NIAGADS provides an integrated suite of resources for discovering, exploring, and accessing Alzheimer’s 
...
export const RESOURCES = [
    {
        ...
        name: "GenomicsDB",
        description:
            `The NIAGADS Alzheimer’s GenomicsDB is an interactive knowledgebase for exploring AD/ADRD genetic associations, 
    ...
    },
    {
        ...
        name: "xQTL Browser",
        description:
            `The ADSP FunGen xQTL Browser provides access to harmonized molecular QTL and fine-mapping results 
    ...
    },
    {
        ...
        description:
            `FILER is a harmonized, searchable collection of human functional genomics data assembled from major resources including
    ...
    },
    {
        ...
        name: "DSS",
        description:
            `The NIAGADS Data Sharing Service (DSS) provides qualified access to genetics, genomics, phenotypic, 
    ...
    },
    {
        ...
        description:
            `The NIAGADS Open Access API provides programmatic access to NIAGADS open data, 
    ...
    },
    {
        ...
        name: "ADVP",
        description:
            `The Alzheimer’s Disease Variant Portal (ADVP) is a curated, harmonized collection of published genetic associations
    ...
    },
    {
        ...
        description:
            `The Alzheimer’s Disease Sequencing Project Phenotype Harmonization Consortium (ADSP-PHC) harmonizes phenotypic and endophenotypic data
