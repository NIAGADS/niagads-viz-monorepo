          ...
          <table className="data-table" role="table">
            <thead>
              <tr role="row">
                ...
                <th role="columnheader" className="sortable" onClick={() => handleSort("id")} aria-sort={ariaSortValue}>
                  ID
                </th>
              ...
              {filteredRecords.map((item: any) => (
                <tr key={item.id} role="row" className={selectedRows.has(item.id) ? "selected" : ""}>
                  ...
                  <td role="gridcell" className="scientific-notation">
                    <Link href={`/records/${item.type}/${item.id}`} className="text-primary-blue hover:underline">
                      {item.id}
                    </Link>
                  </td>
                  <td role="gridcell">
