        ...
        <div className="max-text-width">
            <div className="content-header">
                <div>
                    ...
                    <p className="content-subtitle">
                        Explore genomic datasets and search for genes, variants, and associations
                    </p>
                </div>
            ...
            <div className="card">
                ...
                <div className="text-sm text-secondary">
                    Try searching for: <span className="font-medium">APOE</span>,{" "}
                    <span className="font-medium">rs429358</span>, or{" "}
                        ...
                        <tbody>
                            {datasets.map((dataset) => (
                                <tr
                                    key={dataset.id}
                                    role="row"
                                    className={selectedDatasets.has(dataset.id) ? "selected" : ""}
                                >
                                    <td role="gridcell">
                                        <input
                                            type="checkbox"
