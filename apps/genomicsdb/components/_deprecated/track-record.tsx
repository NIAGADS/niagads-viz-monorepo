                                ...
                                <div className="gene-info-content">
                                    ...
                                    <div className="gene-details">
                                        ...
                                        <div className="gene-type">
                                            ...
                                            {record.experimental_design.analysis}
                                        </div>
                                ...
                                <div className="info-grid">
                                    <div className="info-item">
                                        ...
                                        <span className="info-value">
                                            {record.file_properties.file_format.toUpperCase()}
                                        </span>
                                    </div>
                                    <div className="info-item">
                                        <span className="info-label">Schema:</span>
                                        <span className="info-value">
                                            {record.file_properties.file_schema || "Standard"}
                                        </span>
                                    </div>
                                    <div className="info-item">
                                                    ...
                                                    {record.subject_phenotypes.study_diagnosis.map(
                                                        (diagnosis, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td>
                                                                    {diagnosis.num_controls?.toLocaleString() || "—"}
                                                                </td>
                                                                <td>
                                                                    {(
                                                                        (diagnosis.num_cases || 0) +
                                                                        (diagnosis.num_controls || 0)
                                                                    ).toLocaleString()}
                                                                </td>
                                                            </tr>
                                                        )
                        ...
                        <div className="card">
                            ...
                            <Placeholder type="list">
                                <div className="placeholder-text">
                                    Related tracks will be loaded from collection endpoint
                                </div>
                            </Placeholder>
                        </div>
                    </div>
                    ...
                    <div className="visualization-section">
                        <div className="card">
                            ...
                            <Placeholder type="chart" height={500}>
                                <div className="placeholder-text">
                                    Genome browser visualization will be displayed here
                                </div>
                            </Placeholder>
                        </div>
                    </div>
