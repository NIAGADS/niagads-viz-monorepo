    ...
    <div>
      ...
      <section className="hero-section">
        <div className="max-text-width">
          <h1 className="hero-title">The NIAGADS <br />Alzheimer's Genomics Database</h1>
          <p className="hero-subtitle">
            is an interactive knowledgebase for Alzheimer's disease (AD) genetics. 
            It provides a platform for data sharing, discovery, and analysis to help advance the understanding of the complex genetic underpinnings of AD neurodegeneration and accelerate the progress of research on AD and AD related dementias (ADRD).
        ...
        <div className="max-text-width">
          <div className="text-center mb-15">
            ...
            <p className="text-lg text-secondary max-width-600">
              Discover insights in Alzheimer's disease genomics with our comprehensive suite of analysis tools
            </p>
          </div>
      ...
      <section className="stats-section">
        <div className="max-text-width">
          <h2 className="text-2xl font-bold text-primary mb-15">Explore AD/ADRD Genetic Evidence for AD/ADRD</h2>
          <div className="section-description">For each dataset we provide a detailed interactive report summarizing the top risk-associated variants. These variants are are annotated using the ADSP Annotation Pipeline (Butkiewicz et al. Bioinformatics 2018 / PMID: <a href="https://pubmed.ncbi.nlm.nih.gov/29590295/" target="_blank">29590295</a>) and mapped against sequence features and functional genomics data tracks to help researchers explore the potential impact of risk-associated variants in a broader genomics context.</div>
      ...
      <section style={{ padding: "4rem 2rem" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="text-center mb-15">
            ...
            <p className="text-lg text-secondary">Begin your research journey with these popular starting points</p>
          </div>
          ...
          <div className="feature-grid">
            ...
            >
              ...
              <p className="feature-description">Browse genome-wide association studies for Alzheimer's disease</p>
            </div>
            ...
            >
              ...
              <p className="feature-description">Explore variants on chromosome 19, enriched for AD associations</p>
            </div>
          </div>
        </div>
      </section>
