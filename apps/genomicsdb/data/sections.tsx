    ...
    tables: [
        {
            ...
            description: "",
            endpoint: "/associations?trait=AD&source=GWAS",
            tableType: "associations",
        },
        {
            id: "gwas-adrd",
            label: "AD-Related Dementias",
            description: "",
            endpoint: "/associations?trait=ADRD&source=GWAS",
            tableType: "associations",
        },
        {
            id: "gwas-biomarker",
            ...
            description: "",
            endpoint: "/associations?trait=BIOMARKER&source=GWAS",
            tableType: "associations",
        },
    ],
};
    ...
    tables: [
        {
            ...
            label: "Alzheimer's Disease",
            description: "",
            endpoint: "/associations?trait=AD&source=CURATED",
            tableType: "associations",
        },
        {
            id: "curated-adrd",
            label: "AD-Related Dementias",
            description: "",
            endpoint: "/associations?trait=ADRD&source=CURATED",
            tableType: "associations",
        },
        {
            ...
            label: "AD/ADRD Biomarkers",
            description: "",
            endpoint: "/associations?trait=BIOMARKER&source=CURATED",
            tableType: "associations",
        },
        {
            id: "curated-Other",
            ...
            description: "",
            endpoint: "/associations?trait=OTHER&source=CURATED",
            tableType: "associations",
        },
    ],
};
