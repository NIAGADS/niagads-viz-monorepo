...
export const Skeleton = ({ type }: SkeletonProps) => {
    ...
    return type === "default" ? (
        ...
        <div role="status" className="max-w-sm p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6">
        ...
        <div role="status" className="p-4 space-y-4 border border-gray-200 divide-y divide-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 ">
            <div className="flex">
