...
const COMMON_GENES = new Set(["APOE", "TREM2", "APP", "PSEN1", "PSEN2", "MAPT", "CLU", "CR1", "PICALM", "BIN1", "ABCA7", "CD33", "MS4A6A", "CD2AP", "EPHA1", "PTK2B", "SORL1", "HLA-DRB5", "INPP5D", "MEF2C", "NME8", "ZCWPW1", "CELF1", "FERMT2", "SLC24A4", "CASS4", "ECHDC3", "ACE", "ADAMTS1", "HESX1", "CLNK"])
