    ...
    <div className="app-container">
      ...
      <div className="content-container">
        ...
        {shouldShowSidebar && sidebarOpen && (
          <div className={`mobile-menu-overlay ${sidebarOpen ? "open" : ""}`} onClick={() => setSidebarOpen(false)} />
        )}
        <main className={`main-content ${shouldShowSidebar ? "with-sidebar" : "without-sidebar"}`}>{children}</main>
      </div>
      <Footer />
