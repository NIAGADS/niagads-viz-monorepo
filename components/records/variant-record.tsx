        ...
        {activeSection === "overview" && (
          <div className="overview-section">
            ...
            <div className="card">
              <h3>Summary</h3>
              <p>
                {record.id} is a {record.consequence} variant located on chromosome {record.chromosome} at position{" "}
                {record.position}. It has a minor allele frequency of {record.maf} and is associated with{" "}
                {record.phenotypes.join(", ")}.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p>This variant is predicted to have a {record.impact.toLowerCase()} impact on gene function.</p>
            </div>
          </div>
        )}
        ...
        {activeSection === "linkage" && (
          <div className="linkage-section">
            ...
            <div className="card">
              <h3>LD Plot</h3>
              <div className="placeholder-chart">
                <div className="placeholder-text">Linkage disequilibrium data will be displayed here</div>
              </div>
            </div>
          </div>
        )}
