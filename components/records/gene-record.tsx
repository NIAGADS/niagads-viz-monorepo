          ...
          <div className="niagads-gwas-section">
            {(!currentTab || currentTab === "niagads-alzheimers") && (
              <div className="card">
                ...
                <Placeholder type="table">
                  <div className="placeholder-text">NIAGADS Alzheimer's disease GWAS data will be displayed here</div>
                </Placeholder>
              </div>
            )}
            ...
            {currentTab === "niagads-neuropathologies" && (
              <div className="card">
                ...
                <Placeholder type="table">
                  <div className="placeholder-text">NIAGADS AD-related neuropathology data will be displayed here</div>
                </Placeholder>
              </div>
            )}
          </div>
          ...
          <div className="gwas-catalog-section">
            {(!currentTab || currentTab === "gwas-alzheimers") && (
              <div className="card">
                <h3>Alzheimer's Disease Associations</h3>
                <Placeholder type="table">
                  <div className="placeholder-text">GWAS Catalog Alzheimer's disease data will be displayed here</div>
                </Placeholder>
              </div>
            )}
            ...
            {currentTab === "gwas-other-traits" && (
              <div className="card">
                ...
                <Placeholder type="table">
                  <div className="placeholder-text">GWAS Catalog other trait associations will be displayed here</div>
                </Placeholder>
              </div>
            )}
          </div>
          ...
          <div className="link-outs-section">
            ...
            {currentTab === "clinical" && (
              <div className="card">
                ...
                <Placeholder type="list">
                  <div className="placeholder-text">Clinical database links will be displayed here</div>
                </Placeholder>
              </div>
            )}
            ...
            {currentTab === "proteins" && (
              <div className="card">
                ...
                <Placeholder type="list">
                  <div className="placeholder-text">Protein database links will be displayed here</div>
                </Placeholder>
              </div>
            )}
            ...
            {currentTab === "nucleotide-sequences" && (
              <div className="card">
                ...
                <Placeholder type="list">
                  <div className="placeholder-text">Nucleotide sequence links will be displayed here</div>
                </Placeholder>
              </div>
            )}
                ...
                {record.go_annotation && record.go_annotation.length > 0 ? (
                  <div className="go-annotations">
                    {record.go_annotation.slice(0, 10).map((annotation, index) => (
                      <div key={index} className="go-annotation-item">
                        <div className="go-term">
                          <span className="go-id">{annotation.go_term_id.replace("_", ":")}</span>
                          <span className="go-name">{annotation.go_term}</span>
                        </div>
                        <div className="go-ontology">
                          <span className={`ontology-badge ${annotation.ontology.toLowerCase()}`}>
                            {annotation.ontology}
                          </span>
                        </div>
                      </div>
                    ...
                    {record.go_annotation.length > 10 && (
                      <div className="go-more">+{record.go_annotation.length - 10} more annotations</div>
                    )}
                  </div>
                ) : (
                  <Placeholder type="table">
