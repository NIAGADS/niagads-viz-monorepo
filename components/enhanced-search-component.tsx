      ...
      <div className="search-input-wrapper">
        ...
        {searchAnalysis && searchAnalysis.detectedType && (
          <div className="search-type-hint">
            <span className={`type-badge type-${searchAnalysis.detectedType}`}>{searchAnalysis.detectedType}</span>
          </div>
        )}
      </div>
              ...
              >
                <div className="suggestion-content">
                  ...
                  {analysis.detectedType && (
                    <span className={`suggestion-type type-${analysis.detectedType}`}>{analysis.detectedType}</span>
                  )}
                </div>
                {analysis.route.type === "record" && <ArrowRight size={14} className="suggestion-arrow" />}
              </div>
            )
          })}
        </div>
